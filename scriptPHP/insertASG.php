<?php
    ...
    try{
		...
		$stm = $dbh->prepare("INSERT INTO SitoSoftairLupiDiToscana.ASG (Nome,Marca,Descrizione,Potenza, ImmagineSN, idProprietario) VALUE(:nome,:marca,:descrizione,:potenza, 0, :id)");
